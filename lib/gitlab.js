...
module.exports = {
  ...
  getSnippet: function (id, lastEtag) {
    return getSimple("/snippets/" + id, lastEtag);
  },

  createSnippet: function (snippetData, accessToken) {
    return new Promise((resolve, reject) => {

      sendGitLab({ path: "/api/v4/snippets", method: "POST", body: snippetData, accessToken: accessToken }).then(function (result) {
