...
const defaultAccessToken = settings.git.accessToken;
...
module.exports = {
    ...
    // getApp: function(id,lastEtag) {
    //     return getSimple("/apps/"+id,lastEtag);
    // },

    // createApp: function(appData,accessToken) {
    //     return new Promise((resolve,reject) => {
    //         send({path:"/apps",method:"POST",body:appData,accessToken:accessToken}).then(function(result) {
    //             resolve(result.data);
    //         }).catch(function(er) { reject(er); });
    //     });
    // },

    // starApp: function(id,accessToken) {
    //     return new Promise((resolve,reject) => {
    //         send({path:"/apps/"+id+"/star",method:"PUT"}).then(function(result) {
    //             if (result.statusCode == 204) {
    //                 resolve();
    //             } else {
    //                 reject();
    ...
    // unstarApp: function(id,accessToken) {
    //     return new Promise((resolve,reject) => {
    //         send({path:"/apps/"+id+"/star",method:"DELETE"}).then(function(result) {
    //             if (result.statusCode == 204) {
    //                 resolve();
    //             } else {
    //                 reject();
    ...
    // isAppStarred: function(id,accessToken) {
    //     return new Promise((resolve,reject) => {
    //         send({path:"/apps/"+id+"/star",method:"GET"}).then(function(result) {
    //             if (result.statusCode == 204) {
    //                 resolve(true);
    //             } else {
    //                 reject(false);
